<?php
namespace Opencart\Catalog\Model\Owner;
/**
 * Class Product
 *
 * @package Opencart\Catalog\Model\Owner
 */
class AccountStatus extends \Opencart\System\Engine\Model {

	public function getAccounts(array $data = []): array {
		$sql = "SELECT * FROM `" . DB_PREFIX . "account_status` p ";
	...
	public function getAccount(int $user_document): array {
		$sql = "SELECT * FROM `" . DB_PREFIX . "account_status` p  WHERE document_number=".$user_document;
	...
	public function getProduct(int $product_id): array {
		$query = $this->db->query("SELECT DISTINCT * FROM `" . DB_PREFIX . "account_status` p LEFT JOIN `" . DB_PREFIX . "product_description` pd ON (p.`product_id` = pd.`product_id`) WHERE p.`product_id` = '" . (int)$product_id . "' AND pd.`language_id` = '" . (int)$this->config->get('config_language_id') . "'");
	 ...
	 * @return array
	 */
	public function getProductsb(array $data = []): array {
