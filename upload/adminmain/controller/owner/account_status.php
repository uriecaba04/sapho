<?php
namespace Opencart\Admin\Controller\Owner;
/**
 * Class Account Status
 *
 * @package Opencart\Admin\Controller\Owner
 */
class AccountStatus extends \Opencart\System\Engine\Controller {
	...
	public function index(): void{
		...
		$this->response->setOutput($this->load->view('owner/account_status', $data));
	}
	...
	protected function getList(): string{
		...
		$filter_data=[];
		$results = $this->model_owner_account_status->getAccounts($filter_data);
		...
		return $this->load->view('owner/account_list', $data);
	}
...
////////////////////////////////////
	 ...
	 * @return string
	 */
	protected function getListb(): string {
		...
		$product_total = $this->model_owner_account_status->getTotalProducts($filter_data);

		$results = $this->model_owner_account_status->getProducts($filter_data);
		...
		foreach ($results as $result) {
			...
			$product_specials = $this->model_owner_account_status->getSpecials($result['product_id']);
